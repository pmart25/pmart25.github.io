var fabik_core = function() {
    //var e = document.getElementById("fabik-canvas"),
    ...
    fabik_core.prototype.init = function(a, b) {
        k.beforeImageLoad();
        e = Caman(a, b, function() {
            ...
            this.render(function() {
                d(a).after('<canvas id="fabik-canvas-preview"></canvas>');
                f = document.getElementById("fabik-canvas-preview");
                n = f.getContext("2d");
                f.width = 650;
                f.height = 500;
                q();
    ...
    fabik_core.prototype.fit_size = function(a, b, c, d) {
        c /= a;
        var e = d / b;
        d = 1;
    ...
    var q = function() {
            //e = document.getElementById("fabik-canvas");
        ...
        r = function() {
            if (!l) {
                ...
                Caman(a, function() {
                    ...
                    this.render(function() {
                        //var b = document.getElementById("fabik-canvas");
                        ...
                        l = !1;
                        q();
                        d("#fabik-busy").fadeOut("fast");
                        k.afterRender()
                    })
                })
            }
        };
    fabik_core.prototype.setFilter = function(a, b) {
        g.setToolValue(a, b);
        d("#" + a + "Value").html(b);
        r()
    };
    fabik_core.prototype.save = function() {
        //Caman("#fabik-canvas", function() {
		Caman("#c", function() {
            var a = this.canvas.toDataURL(p);
            k.save(a, c)
        })
    };
    fabik_core.prototype.resetFilters = function() {
        ...
        d(".fabik-tool").data("value", 0).removeClass("switched");
        k.afterReset();
        r()
    };
    fabik_core.prototype.setCallback = function(a,
        b) {
        k[a] = b
    };
    fabik_core.prototype.getTools = function() {
        return c
    };
    fabik_core.prototype.getToolValue = function(a) {
        return c[a].value
    };
    fabik_core.prototype.setToolValue = function(a, b) {
        return c[a].value = b
    }
};