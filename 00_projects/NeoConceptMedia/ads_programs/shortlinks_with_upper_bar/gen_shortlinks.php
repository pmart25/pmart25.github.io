...
class ShortUrl
{
     ...
     */
    protected static $table = "ads_short_urls";
   ...
   public function __construct(PDO $pdo) {
    ...
    public function shortCodeToUrl($code, $increment = true) {
        ...
        if ($increment == true) {
            $this->incrementCounter($urlRow["ads_short_urls_id"]);
        } 
    ...
    protected function insertShortCodeInDb($id, $code) {
        ...
        $query = 'UPDATE ' . self::$table .
            ' SET short_code = "'.$code.'" WHERE ads_short_urls_id = "'.$id.'"';
        $stmnt = $this->pdo->prepare($query);
        $params = array(
            "short_code" => $code,
            "id" => $id
    ...
    protected function getUrlFromDb($code) {
        $query = "SELECT ads_short_urls_id, long_url FROM " . self::$table .
...
/**
 *  CREATE TABLE IF NOT EXISTS ads_short_urls (
 *   ads_short_urls_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
