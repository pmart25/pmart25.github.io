...
/***************************************************
	E-mail settings
****************************************************/
 	$website            = 'ncp.freeiz.com/pub_test/';		    // Your site's domain (without www. part)
	$send_to 		    = 'nge.webdesign@gmail.com';		        // backup file will be sent to?
	$from 		        = 'admin_backup@' . $website;	// some hosting providers won’t let you send backups from invalid e-mail address
