		...
		<div class="changelog">
			...
			<div class="under-the-hood three-col">
				...
				<div class="col">
					...
					<p><?php
						printf(
							/* translators: 1: registration_setting(), 2: https://make.wordpress.org/core/2016/10/26/registrationing-your-settings-in-wordpress-4-7/ */
							__( '%1$s <a href="%2$s">has been enhanced</a> to include type, description, and REST API visibility.' ),
							'<code>registration_setting()</code>',
							'https://make.wordpress.org/core/2016/10/26/registrationing-your-settings-in-wordpress-4-7/'
						);
					?></p>
				</div>
				<div class="col">
