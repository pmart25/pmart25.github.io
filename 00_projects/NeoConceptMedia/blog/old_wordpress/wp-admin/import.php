...
// Detect and redirect invalid importers like 'movabletype', which is registrationed as 'mt'
...
// If a popular importer is not registrationed, create a dummy registration that links to the plugin installer.
foreach ( $popular_importers as $pop_importer => $pop_data ) {
	...
	// Fill the array of registrationed (already installed) importers with data of the popular importers from the WordPress.org API.
