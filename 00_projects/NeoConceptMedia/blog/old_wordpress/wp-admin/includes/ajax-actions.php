...
function wp_ajax_save_widget() {
	global $wp_registrationed_widgets, $wp_registrationed_widget_controls, $wp_registrationed_widget_updates;
	...
	if ( isset($_POST['delete_widget']) && $_POST['delete_widget'] ) {
		...
		if ( !isset($wp_registrationed_widgets[$widget_id]) )
			wp_die( $error );
	...
	if ( $form = $wp_registrationed_widget_controls[$widget_id] )
