...
?>
	...
	public function get_columns() {
		 ...
		 * @since 3.5.0
		 *
		 * @param array  $taxonomies An array of registrationed taxonomies to show for attachments.
...
?>
	...
	public function column_default( $post, $column_name ) {
		 ...
		 *
		 * Custom columns are registrationed using the {@see 'manage_media_columns'} filter.
		 *
		 * @since 2.5.0
		 *
