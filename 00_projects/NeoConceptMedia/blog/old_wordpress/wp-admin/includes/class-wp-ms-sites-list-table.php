...
class WP_MS_Sites_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		if ( 'registrationed' === $order_by ) {
			// registrationed is a valid field name.
	...
	public function get_columns() {
		$sites_columns = array(
			...
			'registrationed'  => _x( 'Registered', 'site' ),
			'users'       => __( 'Users' ),
		);
		 ...
		 *                             'blogname', 'lastupdated', 'registrationed', 'users'.
		 */
	...
	/**
	 * Handles the registrationed column output.
	 *
	 * @since 4.3.0
	 * @access public
	 *
	 * @param array $blog Current site.
	 */
	public function column_registrationed( $blog ) {
		global $mode;
		...
		if ( $blog['registrationed'] === '0000-00-00 00:00:00' ) {
			echo '&#x2014;';
		} else {
			echo mysql2date( $date, $blog['registrationed'] );
		}
	}
	...
	public function column_default( $blog, $column_name ) {
		/**
		 * Fires for each registrationed custom column in the Sites list table.
		 *
		 * @since 3.1.0
		 *
