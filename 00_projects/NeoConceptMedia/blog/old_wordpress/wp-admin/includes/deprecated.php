 ...
 *
 * @since 2.7.0
 * @deprecated 3.0.0 Use registration_setting()
 * @see registration_setting()
 *
...
function add_option_update_handler( $option_group, $option_name, $sanitize_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.0.0', 'registration_setting()' );
	registration_setting( $option_group, $option_name, $sanitize_callback );
}
 ...
 *
 * @since 2.7.0
 * @deprecated 3.0.0 Use unregistration_setting()
 * @see unregistration_setting()
 *
...
function remove_option_update_handler( $option_group, $option_name, $sanitize_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.0.0', 'unregistration_setting()' );
	unregistration_setting( $option_group, $option_name, $sanitize_callback );
}
