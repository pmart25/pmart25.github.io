 ...
 */
function registration_importer( $id, $name, $description, $callback ) {
	global $wp_importers;
...
function wp_get_popular_importers() {
	...
	$cache_key = 'popular_importers_' . md5( $GLOBALS ["local"]e . $wp_version );
	...
	return array(
		// slug => name, description, plugin slug, and registration_importer() slug
		'blogger' => array(
			'name' => __( 'Blogger' ),
