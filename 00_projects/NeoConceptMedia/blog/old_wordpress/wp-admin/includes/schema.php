...
CREATE TABLE $wpdb->posts (
  ...
  user_registrationed datetime NOT NULL default '0000-00-00 00:00:00',
  ...
  registrationed datetime NOT NULL default '0000-00-00 00:00:00',
...
CREATE TABLE $wpdb->registration_log (
  ...
  blog_id bigint(20) NOT NULL default '0',
  date_registrationed datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (ID),
  KEY IP (IP)
) $charset_collate;
...
--The Team @ SITE_NAME' );
	...
	if ( ! is_multisite() ) {
		...
		$wpdb->insert( $wpdb->blogs, array( 'site_id' => $network_id, 'blog_id' => 1, 'domain' => $domain, 'path' => $path, 'registrationed' => current_time( 'mysql' ) ) );
