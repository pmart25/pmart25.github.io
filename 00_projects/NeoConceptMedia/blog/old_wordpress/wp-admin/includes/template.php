 ...
 * @since 3.6.0
 *
 * @uses global $wp_meta_boxes Used to retrieve registrationed meta boxes.
 *
 ...
 * registration_setting() for a given setting to give feedback about the submission.
 *
 ...
 * @since 3.0.0
 *
 * @global array $wp_settings_errors Storage array of errors registrationed during this pageload
 *
...
/**
 * Fetch settings errors registrationed by add_settings_error()
 *
...
function get_settings_errors( $setting = '', $sanitize = false ) {
	 ...
	 * This allows the $sanitize_callback from registration_setting() to run, adding
...
/**
 * Display settings errors registrationed by add_settings_error().
 *
 ...
 * callback function for a setting defined in registration_setting().
 *
