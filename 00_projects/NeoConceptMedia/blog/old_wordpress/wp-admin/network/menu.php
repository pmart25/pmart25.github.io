...
$menu[25] = array(__('Settings'), 'manage_network_options', 'settings', '', 'menu-top menu-icon-settings', 'menu-settings', 'dashicons-admin-settings');
if ( defined( 'MULTISITE' ) && defined( 'WP_ALLOW_MULTISITE' ) && WP_ALLOW_MULTISITE ) {
	$submenu['settings'][5]  = array( __('Network Settings'), 'manage_network_options', 'settings' );
	$submenu['settings'][10] = array( __('Network Setup'), 'manage_network_options', 'setup.php' );
}
unset($update_data);
