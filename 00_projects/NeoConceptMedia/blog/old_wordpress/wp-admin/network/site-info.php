...
<form method="post" action="site-info.php?action=update-site">
	...
	<table class="form-table">
		...
		<tr class="form-field">
			<th scope="row"><label for="blog_registrationed"><?php _ex( 'Registered', 'site' ) ?></label></th>
			<td><input name="blog[registrationed]" type="text" id="blog_registrationed" value="<?php echo esc_attr( $details->registrationed ) ?>" /></td>
		</tr>
		<tr class="form-field">
