...
<?php _e('Users must be registrationed and logged in to comment'); ?>
<?php if ( !get_option( 'users_can_registration' ) && is_multisite() ) echo ' ' . __( '(Signup has been disabled. Only members of this site can comment.)' ); ?>
</label>
<br />
