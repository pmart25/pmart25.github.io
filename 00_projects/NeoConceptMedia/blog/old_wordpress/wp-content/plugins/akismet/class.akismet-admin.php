...
class Akismet_Admin {
	...
	public static function load_resources() {
		...
		if ( in_array( $hook_suffix, array(
			...
			wp_registration_style( 'akismet.css', plugin_dir_url( __FILE__ ) . '_inc/akismet.css', array(), AKISMET_VERSION );
			wp_enqueue_style( 'akismet.css');

			wp_registration_script( 'akismet.js', plugin_dir_url( __FILE__ ) . '_inc/akismet.js', array('jquery','postbox'), AKISMET_VERSION );
