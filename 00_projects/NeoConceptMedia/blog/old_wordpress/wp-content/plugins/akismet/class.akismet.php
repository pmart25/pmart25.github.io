...
class Akismet {
	...
	public static function load_form_js() {
		...
		wp_registration_script( 'akismet-form', plugin_dir_url( __FILE__ ) . '_inc/form.js', array(), AKISMET_VERSION, true );
...
<?php
	...
	/**
	 * Attached to activate_{ plugin_basename( __FILES__ ) } by registration_activation_hook()
	 * @static
	 */
