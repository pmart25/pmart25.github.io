 ...
 */
function twentyfifteen_customize_registration( $wp_customize ) {
...
add_action( 'customize_registration', 'twentyfifteen_customize_registration', 11 );

/**
 * Render the site title for the selective refresh partial.
 *
 * @since Twenty Fifteen 1.5
 * @see twentyfifteen_customize_registration()
 *
 * @return void
 */
...
function twentyfifteen_get_color_schemes() {
	/**
	 * Filter the color schemes registrationed for use with Twenty Fifteen.
	 *
...
/**
 * Returns an array of color scheme choices registrationed for Twenty Fifteen.
 *
 * @since Twenty Fifteen 1.0
 *
