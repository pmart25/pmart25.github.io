 ...
 */
function twentyseventeen_customize_registration( $wp_customize ) {
...
add_action( 'customize_registration', 'twentyseventeen_customize_registration' );
 ...
 *
 * @since Twenty Seventeen 1.0
 * @see twentyseventeen_customize_registration()
 *
 * @return void
 */
