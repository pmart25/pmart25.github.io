 ...
 */
function twentysixteen_customize_registration( $wp_customize ) {
	$color_scheme = twentysixteen_get_color_scheme();
...
add_action( 'customize_registration', 'twentysixteen_customize_registration', 11 );

/**
 * Render the site title for the selective refresh partial.
 *
 * @since Twenty Sixteen 1.2
 * @see twentysixteen_customize_registration()
 *
 * @return void
 */
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registrationed for use with Twenty Sixteen.
	 *
...
/**
 * Retrieves an array of color scheme choices registrationed for Twenty Sixteen.
 *
...
function twentysixteen_get_color_scheme_css( $colors ) {
	...
	.gallery-caption,
	.widecolumn label,
	.widecolumn .mu_registration label {
		color: {$colors['secondary_text_color']};
	}
	...
	.comment-reply-link,
	.no-comments,
	.widecolumn .mu_registration .mu_alert {
