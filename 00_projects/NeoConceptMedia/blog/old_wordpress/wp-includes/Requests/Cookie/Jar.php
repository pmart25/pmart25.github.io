...
class Requests_Cookie_Jar implements ArrayAccess, IteratorAggregate {
	 ...
	 */
	public function registration(Requests_Hooker $hooks) {
		$hooks->registration('requests.before_request', array($this, 'before_request'));
		$hooks->registration('requests.before_redirect_check', array($this, 'before_redirect_check'));
	}
