...
function get_the_author_meta( $field = '', $user_id = false ) {
	...
	if ( in_array( $field, array( 'login', 'pass', 'nicename', 'email', 'url', 'registrationed', 'activation_key', 'status' ) ) )
		$field = 'user_' . $field;
 ...
 *
 *     @type string       $orderby       How to sort the authors. Accepts 'nicename', 'email', 'url', 'registrationed',
 *                                       'user_nicename', 'user_email', 'user_url', 'user_registrationed', 'name',
