...
function map_meta_cap( $cap, $user_id ) {
	...
	case 'delete_page':
		...
		if ( ! $post_type ) {
			...
			_doing_it_wrong( __FUNCTION__, sprintf( __( 'The post type %1$s is not registrationed, so it may not be reliable to check the capability "%2$s" against a post of that type.' ), $post->post_type, $cap ), '4.4.0' );
