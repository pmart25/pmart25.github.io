...
class WP_Customize_Panel {
	 ...
	 *
	 * This function is only run for panel types that have been registrationed with
	 * WP_Customize_Manager::registration_panel_type().
	 *
	 * @since 4.3.0
	 *
	 * @see WP_Customize_Manager::registration_panel_type()
	 */
