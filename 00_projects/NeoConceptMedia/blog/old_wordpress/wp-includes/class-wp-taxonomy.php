...
final class WP_Taxonomy {
	...
	/**
	 * An array of object types this taxonomy is registrationed for.
	 *
	 * @since 4.7.0
	 * @access public
	 * @var array
	 ...
	 * @param array|string $args        Optional. Array or query string of arguments for registrationing a taxonomy.
	 *                                  Default empty array.
	 */
	 ...
	 *
	 * @param array|string $object_type Name of the object type for the taxonomy object.
	 * @param array|string $args        Array or query string of arguments for registrationing a taxonomy.
	 */
	public function set_props( $object_type, $args ) {
		$args = wp_parse_args( $args );

		/**
		 * Filters the arguments for registrationing a taxonomy.
		 *
		 * @since 4.4.0
		 *
		 * @param array  $args        Array of arguments for registrationing a taxonomy.
		 * @param string $taxonomy    Taxonomy key.
		 * @param array  $object_type Array of names of object types for the taxonomy.
		 */
		$args = apply_filters( 'registration_taxonomy_args', $args, $this->name, (array) $object_type );
	...
	public function add_rewrite_rules() {
		...
		// Non-publicly queryable taxonomies should not registration query vars, except in the admin.
