...
class WP_User_Query {
	 ...
	 *                                             'user_registrationed' (or 'registrationed'), 'post_count', 'meta_value',
	 ...
	 *                                             'user_nicename', 'user_email', 'user_url', 'user_registrationed'.
	...
	public function prepare_query( $query = array() ) {
		...
		// Date queries are allowed for the user_registrationed field.
		if ( ! empty( $qv['date_query'] ) && is_array( $qv['date_query'] ) ) {
			$date_query = new WP_Date_Query( $qv['date_query'], 'user_registrationed' );
	...
	protected function parse_orderby( $orderby ) {
		...
		$_orderby = '';
		if ( in_array( $orderby, array( 'login', 'nicename', 'email', 'url', 'registrationed' ) ) ) {
			$_orderby = 'user_' . $orderby;
		} elseif ( in_array( $orderby, array( 'user_login', 'user_nicename', 'user_email', 'user_url', 'user_registrationed' ) ) ) {
			$_orderby = $orderby;
