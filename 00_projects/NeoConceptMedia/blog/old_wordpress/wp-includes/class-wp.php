...
class WP {
	...
	public function parse_request($extra_query_vars = '') {
		...
		if ( ! is_admin() ) {
			foreach ( get_taxonomies( array( 'publicly_queryable' => false ), 'objects' ) as $taxonomy => $t ) {
				 ...
				 * Non-publicly queryable taxonomies cannot registration custom query vars. See registration_taxonomy().
				 */
	 ...
	 */
	public function registration_globals() {
		global $wp_query;
