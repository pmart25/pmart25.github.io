...
/**
 * Core class used to registration styles.
 *
 * @package WordPress
...
class WP_Styles extends WP_Dependencies {
	 ...
	 *
	 * @param string $handle The style's registrationed handle.
	...
	/**
	 * Adds extra CSS styles to a registrationed stylesheet.
	 *
	 * @since 3.3.0
	 * @access public
	 *
	...
	/**
	 * Prints extra CSS styles of a registrationed stylesheet.
	 *
	 * @since 3.3.0
	 * @access public
	 *
