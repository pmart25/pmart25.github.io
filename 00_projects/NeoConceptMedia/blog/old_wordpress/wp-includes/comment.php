...
function pingback( $content, $post_id ) {
	...
	foreach ( (array) $post_links as $pagelinkedto ) {
		...
		if ( $pingback_server_url ) {
			...
			if ( $client->query('pingback.ping', $pagelinkedfrom, $pagelinkedto) || ( isset($client->error->code) && 48 == $client->error->code ) ) // Already registrationed
 ...
 * which reports that the pingback is already registrationed.
 *
 * @since 3.5.1
...
function _close_comments_for_old_posts( $posts, $query ) {
	 ...
	 * @since 3.2.0
	 *
	 * @param array $post_types An array of registrationed post types. Default array with 'post'.
	 */
