...
// Meta
add_filter( 'registration_meta_args', '_wp_registration_meta_args_whitelist', 10, 2 );
...
// Admin Color Schemes
add_action( 'admin_init', 'registration_admin_color_schemes', 1);
...
add_action( 'registration_new_user',      'wp_send_new_user_notifications' );
add_action( 'edit_user_created_user', 'wp_send_new_user_notifications', 10, 2 );

// REST API actions.
add_action( 'init',          'rest_api_init' );
add_action( 'rest_api_init', 'rest_api_default_filters',   10, 1 );
add_action( 'rest_api_init', 'registration_initial_settings',  10 );
...
// Embeds
add_action( 'rest_api_init',          'wp_oembed_registration_route'              );
