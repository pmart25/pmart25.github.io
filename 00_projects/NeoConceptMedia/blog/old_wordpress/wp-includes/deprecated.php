 ...
 *
 * Passes to wp_registration_sidebar_widget() after argument list and backward
 * compatibility is complete.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use wp_registration_sidebar_widget()
 * @see wp_registration_sidebar_widget()
 *
 ...
 */
function registration_sidebar_widget($name, $output_callback, $classname = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'wp_registration_sidebar_widget()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
	...
	call_user_func_array('wp_registration_sidebar_widget', $args);
}

/**
 * Serves as an alias of wp_unregistration_sidebar_widget().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use wp_unregistration_sidebar_widget()
 * @see wp_unregistration_sidebar_widget()
 *
 * @param int|string $id Widget ID.
 */
function unregistration_sidebar_widget($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'wp_unregistration_sidebar_widget()' );
	return wp_unregistration_sidebar_widget($id);
}
 ...
 * the array for the name.
 *
 * Passes to wp_registration_widget_control() after the argument list has
 * been compiled.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use wp_registration_widget_control()
 * @see wp_registration_widget_control()
 *
 ...
 */
function registration_widget_control($name, $control_callback, $width = '', $height = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'wp_registration_widget_control()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
			$name = sprintf($name[0], $name[2]);
	...
	call_user_func_array('wp_registration_widget_control', $args);
}

/**
 * Alias of wp_unregistration_widget_control().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use wp_unregistration_widget_control()
 * @see wp_unregistration_widget_control()
 *
 * @param int|string $id Widget ID.
 */
function unregistration_widget_control($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'wp_unregistration_widget_control()' );
	return wp_unregistration_widget_control($id);
}
