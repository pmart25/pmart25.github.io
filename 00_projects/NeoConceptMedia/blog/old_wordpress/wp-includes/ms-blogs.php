...
function update_blog_details( $blog_id, $details = array() ) {
	...
	$fields = array( 'site_id', 'domain', 'path', 'registrationed', 'last_updated', 'public', 'archived', 'mature', 'spam', 'deleted', 'lang_id');
 ...
 *                                           'network_id', 'last_updated', 'registrationed', 'domain_length',
...
function update_blog_status( $blog_id, $pref, $value, $deprecated = null ) {
	...
	if ( ! in_array( $pref, array( 'site_id', 'domain', 'path', 'registrationed', 'last_updated', 'public', 'archived', 'mature', 'spam', 'deleted', 'lang_id') ) )
		return $value;
