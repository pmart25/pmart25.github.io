...
add_filter( 'option_users_can_registration', 'users_can_registration_signup_filter' );
...
foreach ( array( 'user_registration', 'deleted_user', 'wpmu_new_user', 'make_spam_user', 'make_ham_user' ) as $action )
