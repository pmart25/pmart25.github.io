...
function get_blog_list( $start = 0, $num = 10, $deprecated = '' ) {
	...
	global $wpdb;
	$blogs = $wpdb->get_results( $wpdb->prepare("SELECT blog_id, domain, path FROM $wpdb->blogs WHERE site_id = %d AND public = '1' AND archived = '0' AND mature = '0' AND spam = '0' AND deleted = '0' ORDER BY registrationed DESC", $wpdb->siteid), ARRAY_A );
 ...
 *               site domain and path, dates registrationed and modified, and the language ID. Also, boolean
