...
/**
 * Check if any filter has been registrationed for a hook.
 *
 * @since 2.5.0
 *
 ...
 *                   anything registrationed. When checking a specific function, the priority of that
...
/**
 * Check if any action has been registrationed for a hook.
 *
 * @since 2.5.0
 *
 ...
 * @return bool Whether the path was able to be registrationed.
 */
function wp_registration_plugin_realpath( $file ) {
	global $wp_plugin_paths;
 ...
 */
function registration_activation_hook($file, $function) {
 ...
 */
function registration_deactivation_hook($file, $function) {
	$file = plugin_basename($file);
 ...
 * registrationing the uninstall hook. In order to run using the hook, the plugin
 ...
 */
function registration_uninstall_hook( $file, $callback ) {
