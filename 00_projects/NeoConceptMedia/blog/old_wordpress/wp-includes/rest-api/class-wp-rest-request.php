...
class WP_REST_Request implements ArrayAccess {
	 ...
	 *
	 * This is the options array used when the route was registrationed, typically
	 ...
	 *
	 * This is primarily based off the sanitize_callback param on each registrationed
	 * argument.
	 *
	 * @since 4.4.0
	 * @access public
	...
	public function has_valid_params() {
		...
		/*
		 * Check the validation callbacks for each registrationed arg.
		 *
