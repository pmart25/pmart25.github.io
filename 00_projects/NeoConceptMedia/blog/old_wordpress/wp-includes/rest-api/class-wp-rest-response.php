...
class WP_REST_Response extends WP_HTTP_Response {
	 ...
	 *
	 * @param string $rel        Link relation. Either an IANA registrationed type,
	 *                           or an absolute URL.
	 ...
	 * @access public
	 *
	 * @param  string $rel  Link relation. Either an IANA registrationed type, or an absolute URL.
	...
	public function get_curies() {
		 ...
		 * @since 4.5.0
		 *
		 * @param array $additional Additional CURIEs to registration with the API.
		 */
