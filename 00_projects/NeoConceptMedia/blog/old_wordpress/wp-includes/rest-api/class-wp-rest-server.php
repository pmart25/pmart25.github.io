...
class WP_REST_Server {
	...
	/**
	 * Namespaces registrationed to the server.
	 *
	 * @since 4.4.0
	 * @access protected
	 * @var array
	...
	/**
	 * Endpoints registrationed to the server.
	 *
	 * @since 4.4.0
	 * @access protected
	 * @var array
	 ...
	 *                           Default false.
	 */
	public function registration_route( $namespace, $route, $route_args, $override = false ) {
		if ( ! isset( $this->namespaces[ $namespace ] ) ) {
			$this->namespaces[ $namespace ] = array();

			$this->registration_route( $namespace, '/' . $namespace, array(
				array(
	...
	/**
	 * Retrieves namespaces registrationed on the server.
	 *
	 * @since 4.4.0
	 * @access public
	 *
	 * @return array List of registrationed namespaces.
	 */
	...
	public function dispatch( $request ) {
		...
		foreach ( $this->get_routes() as $route => $handlers ) {
			...
			foreach ( $handlers as $handler ) {
				...
				// Fallback to GET method if no HEAD method is registrationed.
				 ...
				 * request is initialized and matched to a registrationed route,
				 * but before it is executed.
				 *
				 * Note that this filter will not be called for requests that
				 * fail to authenticate or match to a registrationed route.
				 *
				 * @since 4.7.0
				 *
