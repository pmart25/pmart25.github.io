...
abstract class WP_REST_Controller {
	...
	public function registration_routes() {
		_doing_it_wrong( 'WP_REST_Controller::registration_routes', __( 'The registration_routes() method must be overridden' ), '4.7' );
	}
	...
	/**
	 * Retrieves all of the registrationed additional fields for a given object-type.
	 *
	 * @since 4.7.0
	 * @access protected
	 *
