...
class WP_REST_Settings_Controller extends WP_REST_Controller {
	...
	public function get_item( $request ) {
		$options  = $this->get_registrationed_options();
		$response = array();
		...
		foreach ( $options as $name => $args ) {
			 ...
			 *                       matching the registrationed schema for the setting, or null to
			 *                       follow the default get_option() behavior.
			 * @param string $name   Setting name (as shown in REST API responses).
			 * @param array  $args   Arguments passed to registration_setting() for this setting.
			 */
			 ...
			 * cast values to the type they are registrationed with.
			 */
	...
	/**
	 * Retrieves all of the registrationed options for the Settings API.
	 *
	 * @since 4.7.0
	 * @access protected
	 *
	 * @return array Array of registrationed options.
	 */
	protected function get_registrationed_options() {
		$rest_options = array();

		foreach ( get_registrationed_settings() as $name => $args ) {
