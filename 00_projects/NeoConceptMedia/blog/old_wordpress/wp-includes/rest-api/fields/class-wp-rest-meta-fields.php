...
abstract class WP_REST_Meta_Fields {
	...
	/**
	 * Retrieves the object type for registration_rest_field().
	 *
	 * @since 4.7.0
	 * @access protected
	 *
	 ...
	 * @access public
	 *
	 * @see registration_rest_field()
	 */
	public function registration_field() {
		registration_rest_field( $this->get_rest_field_type(), 'meta', array(
	...
	public function get_value( $object_id, $request ) {
		$fields   = $this->get_registrationed_fields();
		$response = array();
	...
	/**
	 * Retrieves all the registrationed meta fields.
	 *
	 * @since 4.7.0
	 * @access protected
	 *
	 ...
	 */
	protected function get_registrationed_fields() {
		$registrationed = array();

		foreach ( get_registrationed_meta_keys( $this->get_meta_type() ) as $name => $args ) {
