...
/**
 * Whether a registrationed shortcode exists named $tag
 *
 * @since 3.6.0
 *
...
function do_shortcode( $content, $ignore_html = false ) {
	...
	// Find all registrationed tag names in $content.
 ...
 * @global array $shortcode_tags
 *
 * @param array $tagnames Optional. List of shortcodes to find. Defaults to all registrationed shortcodes.
