 ...
 *
 * This function fires twice: in wp-settings before plugins are loaded (for
 * backward compatibility reasons), and again on the {@see 'init'} action. We must
 * avoid registrationing rewrite rules before the {@see 'init'} action.
 *
 * @since 2.8.0
 *
...
function create_initial_taxonomies() {
	...
	registration_taxonomy( 'category', 'post', array(
		'hierarchical' => true,
	...
	registration_taxonomy( 'post_tag', 'post', array(
	 	'hierarchical' => false,
		'query_var' => 'tag',
	...
	registration_taxonomy( 'nav_menu', 'nav_menu_item', array(
		'public' => false,
		'hierarchical' => false,
		'labels' => array(
	...
	registration_taxonomy( 'link_category', 'link', array(
		'hierarchical' => false,
		'labels' => array(
	...
	registration_taxonomy( 'post_format', 'post', array(
		'public' => true,
		'hierarchical' => false,
		'labels' => array(
...
/**
 * Retrieves a list of registrationed taxonomy names or objects.
 *
 * @since 3.0.0
 *
 * @global array $wp_taxonomies The registrationed taxonomies.
 *
...
/**
 * Return the names or objects of the taxonomies which are registrationed for the requested object or object type, such as
 ...
 *              arguments to registration the Taxonomy in REST API.
 *
 ...
 *     Optional. Array or query string of arguments for registrationing a taxonomy.
 *
 ...
 */
function registration_taxonomy( $taxonomy, $object_type, $args = array() ) {
	global $wp_taxonomies;
	...
	/**
	 * Fires after a taxonomy is registrationed.
	 *
	 * @since 3.3.0
	 *
	 ...
	 */
	do_action( 'registrationed_taxonomy', $taxonomy, $object_type, (array) $taxonomy_object );
}

/**
 * Unregistrations a taxonomy.
 *
 * Can not be used to unregistration built-in taxonomies.
 *
 * @since 4.5.0
 *
 ...
 */
function unregistration_taxonomy( $taxonomy ) {
	if ( ! taxonomy_exists( $taxonomy ) ) {
	...
	// Do not allow unregistrationing internal taxonomies.
	if ( $taxonomy_object->_builtin ) {
		return new WP_Error( 'invalid_taxonomy', __( 'Unregistrationing a built-in taxonomy is not allowed' ) );
	}
	...
	/**
	 * Fires after a taxonomy is unregistrationed.
	 *
	 * @since 4.5.0
	 *
	 * @param string $taxonomy Taxonomy name.
	 */
	do_action( 'unregistrationed_taxonomy', $taxonomy );
...
/**
 * Add an already registrationed taxonomy to an object type.
 *
 * @since 3.0.0
 *
 * @global array $wp_taxonomies The registrationed taxonomies.
 ...
 */
function registration_taxonomy_for_object_type( $taxonomy, $object_type) {
	global $wp_taxonomies;
...
/**
 * Remove an already registrationed taxonomy from an object type.
 *
 * @since 3.7.0
 *
 * @global array $wp_taxonomies The registrationed taxonomies.
 ...
 * @return bool True if successful, false if not.
 */
function unregistration_taxonomy_for_object_type( $taxonomy, $object_type ) {
	global $wp_taxonomies;
